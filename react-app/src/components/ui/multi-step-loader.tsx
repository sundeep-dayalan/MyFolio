...
export const MultiStepLoader = ({
  ...
  useEffect(() => {
    ...
    // If currentStep is provided, use it instead of auto-increment
    ...
    <AnimatePresence mode="wait">
      {loading && (
        <motion.div
          ...
          className="w-full h-full fixed inset-0 z-[100] flex items-start justify-center backdrop-blur-2xl"
        >
          <div className="h-96 relative">
            <LoaderCore
              value={currentStep !== undefined ? currentStep : currentState}
