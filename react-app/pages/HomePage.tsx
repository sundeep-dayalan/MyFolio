...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-black/30 backdrop-blur-md border-r border-white/10 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:flex-shrink-0`}>
        ...
        <nav className="mt-8 px-4">
          <div className="space-y-2">
            <a href="#" className="flex items-center space-x-3 px-4 py-3 text-white bg-white/10 rounded-xl">
            ...
            <a href="#" className="flex items-center space-x-3 px-4 py-3 text-slate-300 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="hidden lg:flex items-center space-x-6 mr-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm font-semibold text-white">{formatCurrency(portfolioValue)}</p>
                  </div>
                  <div className="text-center">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-slate-300 max-w-xl mx-auto mb-6">
              Track your investments, monitor performance, and grow your wealth.
              Your personal financial dashboard shows everything you need to make informed decisions.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-2 bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <p className="text-slate-300 text-sm uppercase tracking-wide">Your Portfolio Value</p>
                  <h3 className="text-3xl font-bold text-white mt-2">{formatCurrency(portfolioValue)}</h3>
                  <p className="text-emerald-400 text-lg mt-1">+{formatCurrency(totalGain)} (+{gainPercentage}%)</p>
                </div>
              ...
              <div className="relative h-32 bg-gradient-to-r from-emerald-500/20 to-blue-500/20 rounded-xl p-4">
                ...
                <div className="absolute bottom-4 left-4 text-xs text-slate-300 space-x-4">
                  <span>1D</span> <span>1W</span> <span className="text-emerald-400">1M</span> <span>3M</span> <span>1Y</span> <span>ALL</span>
                </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-slate-300 text-sm uppercase tracking-wide mb-2">Available Cash</p>
              <h3 className="text-2xl font-bold text-white mb-4">{formatCurrency(totalAvailable)}</h3>
              <p className="text-slate-300 text-sm mb-4">Ready to invest</p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 max-w-4xl mx-auto">
            ...
            <div className="mt-6 pt-4 border-t border-white/10">
              <p className="text-slate-400 text-xs text-center">
                Portfolio last updated: {currentTime.toLocaleDateString()} at {currentTime.toLocaleTimeString()}
              </p>
            </div>
          </div>
          </div>
